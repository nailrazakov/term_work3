from src.classes import (Operation, select_state_executed,
                         reading_information, creating_class_instance)
import pytest
...
def test_date_formatting():
    ...
    """
    assert (class_instance.date_formatting("2019-08-26T10:50:58.294041") ==
            '26-08-2019')
...
def test_creating_class_instance(test_data):
    assert str(creating_class_instance(test_data)) == ('[Operation Перевод организации 31957.58, Operation Перевод организации '
 '8221.37, Operation Перевод организации 9824.07, Operation Открытие вклада '
 '48223.05, Operation Перевод со счета на счет 79114.93]')
